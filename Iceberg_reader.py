...
class IcebergReader(BaseReader):
    ...
    def load_data(
            ...
            metadata_columns_in: Optional[List[str]] = None,
            extra_info: Optional[Dict] = None,
    ) -> List[Document]:

        metadata_columns_in = metadata_columns_in if metadata_columns_in is not None else []
        ...
        content_columns, metadata_columns = self._get_columns(all_columns=df.columns.tolist(), metadata_columns_in=metadata_columns_in)
        documents = []
